export default function TermsPage() {
  return (
    <section className="panel rounded-[2rem] p-6 sm:p-8">
      ...
      <h1 className="mt-3 text-3xl font-semibold tracking-[-0.04em] text-white sm:text-4xl">Terms</h1>
      <div className="mt-6 space-y-4 text-sm leading-6 text-white/72">
        ...
        <p>Users are responsible for complying with local laws concerning games of chance and online services.</p>
